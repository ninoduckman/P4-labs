...
Libro::Libro(const std::string &doi, const std::string &titulo, const DTFecha &fecha, const std::string &m_Editorial, const std::set<std::string> &m_PalabrasDestacadas)
    : Publicacion(doi, titulo, fecha), m_Editorial(editorial), m_PalabrasDestacadas(palabrasDestacadas) {}
